...
- [ ] `docs/production-env.md` created
- [ ] All required variables documented
- [ ] Each variable has description, format, and example
- [ ] Includes how to obtain API keys
- [ ] Checklist format for easy verification
- [ ] Security best practices included
- [ ] Troubleshooting section added
- [ ] Clear instructions for setting in Coolify
