# Price Monitor AI Agent – Overview Architecture (old)

## Document overview
This document provides an overview of the OLD architecture of our Price Monitor AI Agent, which developed in the implementation-1 folder.

**Cautions:** This document is now readonly for reference only. **Do NOT update this document.**
